...
class ListFragment : Fragment() {
    ...
    override fun onAttach(context: Context) {
        ...
        (requireParentFragment() as HomeFragment).listComponent.inject(this)
    }
